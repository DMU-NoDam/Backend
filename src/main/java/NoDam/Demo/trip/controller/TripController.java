...
public class TripController {
    ...
    public ResponseEntity<SuccessResponse<TripInfoDto>> createTrip(
        ...
        // date plan 생성, plans 생성
        autoCreatePlanService.autoGenerateDatePlans(trip, request.getSelectedPlace(), request.getRegion())
                .thenAccept((list)-> { autoCreatePlanService.autoGenerateAllPlans(trip); })
                .exceptionally((throwable)->{return null;}); // nothing to do!
