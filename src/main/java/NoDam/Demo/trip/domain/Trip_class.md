...
- 여행 일정 기본 정보 엔티티
# 함수
- public Trip(String name, Long userId, String uuid, int personCount, ScheduleType scheduleType, PriceType priceType, LocalDate startDate, LocalDate endDate, boolean isFixed) : 빌더를 통한 생성
